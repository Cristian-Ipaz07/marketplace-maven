...
const plans = [
  {
    ...
    icon: Zap,
    features: ["15 publicaciones/día", "3 perfiles conectados", "Portadas por categoría", "Importación Excel", "Soporte por email"],
  },
  {
    id: "pro",
    name: "Pro",
    ...
    icon: Crown,
    recommended: true,
    features: ["40 publicaciones/día", "6 perfiles conectados", "Portadas ilimitadas", "Importación Excel", "Soporte prioritario", "Analítica avanzada"],
  },
  {
    id: "business",
    name: "Business",
